      ...
      <div className="w-full flex sm:flex-row flex-col gap-8 sm:px-0 px-4">
        <div className="w-full flex flex-col justify-start items-center gap-8">
          <h1 className="font-bold uppercase sm:text-[2rem] text-[1.5rem]">
            <span className="stroke-text">{Langs[selectedLanguage].testimonialSectionUI.blockTitle1}</span>
            <span className="text-white">{Langs[selectedLanguage].testimonialSectionUI.blockTitle2}</span>
          </h1>
